        ...
        <div class="row">
                        ...
                        <div class="col-sm-8 col-8">
                          ...
                          <div class="a-spacing-mini">
                            ...
                            <span class="a-size-base sc-product-creator"
                              >por {{ produto.proprietario.nome }}</span
                            >
                          </div>
                          <div>
                            <span
                            ...
                            <label>
                              ...
                              <span class="a-checkbox-label">
                                ...
                                <span class="a-size-small">
                                  <a href="#">
                                    <span class="a-size-small">Aprender mais</span>
                                  </a>
                                </span>
                              </span>
                            </label>
                          ...
                          <div class="sc-action-links">
                            <select
                              @change="onMudarQuantidade($event, produto)"
                            >
                              Qtd:
                              <option
                                ...
                                :key="i"
                                :value="i"
                                :selected="checkQtd(produto.quantidade, i)"
                              >
                                {{ i }}
                              </option>
                            </select>
                            ...
                            <span class="a-size-small">
                              <a
                                href="#"
                                @click="
                                  $store.commit('removerProduto', produto)
                                "
                                >Deletar</a
                              >
                            </span>
                          ...
                          <p class="a-spacing-small">
                            <span
                              class="
                                ...
                                a-text-bold
                              "
                              >R$ {{ produto.preco * produto.quantidade }}</span
                            >
                          </p>
                        </div>
                      </div>
                ...
                <div class="text-right">
                  ...
                  <p class="a-spacing-none a-spacing-top-mini">
                    <span class="a-size-medium"
                      >Subtotal ({{ getCarrinhoLength }} item)</span
                    >
                    <span class="a-color-price a-text-bold">
                      <!-- Cart Total Price -->
                      <span class="a-size-medium a-color-price"
                        >R$ {{ getCarrinhoPrecoTotal }}</span
                      >
                    </span>
                  </p>
                </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-5">
                ...
                <div class="a-box-inner">
                  <div class="a-spacing-mini">
                    <p class="a-spacing-none a-spacing-top-none">
                      <!-- Cart Subtotal -->
                      <span class="a-size-medium">
                        <span>Subtotal ({{ getCarrinhoLength }} item):</span>
                        <span class="a-color-price a-text-bold">
                          <!-- Cart Total Price  -->
                          <span class="a-size-medium a-color-price"
                            >R$ {{ getCarrinhoPrecoTotal }}</span
                  ...
                  <div class="a-spacing-base mt-1">
                    ...
                    <span class="a-label a-checkbox-label"
                      >Esse pedido possui um presente</span
                    >
                  </div>
                  <div>
                    <span
                    ...
                    >
                      <span class="a-button-inner">
                        <nuxt-link to="/finalizarPedido" class="a-button-text"
                          >Finalizar pedido</nuxt-link
                        >
                      </span>
                    </span>
                  </div>
            ...
            <div class="a-spacing-large">
              <div class="a-box">
                <div class="a-box-inner">
                  <h5 class="a-spacing-base">Visitados recentemente</h5>
...
export default {
  computed: {
    ...mapGetters([
      "getCarrinho",
      "getCarrinhoPrecoTotal",
      "getCarrinhoLength",
    ]),
  },

  methods: {
    onMudarQuantidade(event, produto) {
      let qtd = parseInt(event.target.value);
      this.$store.commit("mudancaQuantidade", { produto, qtd });
    },

    checkQtd(produtoQtd, qtd) {
      if (parseInt(produtoQtd) === parseInt(qtd)) {
        return true;
      } else {
        return false;
      }
